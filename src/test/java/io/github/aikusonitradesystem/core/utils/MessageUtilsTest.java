...
public class MessageUtilsTest {
    ...
    public void testMessageInEnglish() {
        String message = MessageUtils.m("ats-spring-core.test", null, Locale.ENGLISH);
        assertEquals("This is a test message of the core module.", message);
    }

    @Test
    public void testMessageInKorean() {
        String message = MessageUtils.m("ats-spring-core.test", null, Locale.KOREAN);
    ...
    public void testMessageWithDefault() {
        ...
        String message = MessageUtils.m("ats-spring-core.test.default", null, Locale.ENGLISH);
