package io.github.aikusonitradesystem.core;
...
public class MessageSourceTest {
    ...
    public void testMessageInEnglish() {
        String message = messageSource.getMessage("ats-spring-core.test", null, Locale.ENGLISH);
        assertEquals("This is a test message of the core module.", message);
    }

    @Test
    public void testMessageInKorean() {
        String message = messageSource.getMessage("ats-spring-core.test", null, Locale.KOREAN);
    ...
    public void testMessageWithDefault() {
        ...
        String message = messageSource.getMessage("ats-spring-core.test.default", null, Locale.ENGLISH);
